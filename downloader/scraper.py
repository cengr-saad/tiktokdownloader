...
if __name__ == '__main__':
    ...
    api = Scraper()
    video_url = 'https://www.tiktok.com/@cznburak/video/7267946224807054598?is_from_webapp=1&sender_device=pc'  # Replace with your video URL
    data = asyncio.run(api.hybrid_parsing(video_url))

    if data['status'] == 'success' and data['type'] == 'video':
        video_url = data['video_data']['nwm_video_url_HQ']
        save_path = 'E:\Programs\TikTok_Download_API/videos/video.mp4'  # Replace with your desired file path
